...
2. Модифіковано схему бази даних шляхом редагування `schema.prisma`.
3. Виконано міграцію БД, що додало нові поля та таблиці в PostgreSQL.
4. Написано та протестовано скрипт TypeScript, який підтвердив коректність роботи нових структур даних.